...
mp = maxpool: use strided conv instead of maxpooling if false
up = upconv: use transposed conv instead of upsamping + conv if false
res = residual: add residual connections around each conv block if true
'''
